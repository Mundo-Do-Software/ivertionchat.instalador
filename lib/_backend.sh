...
backend_db_create() {
  ...
  docker run --name redis-ivertionchat \
                -e TZ="America/Sao_Paulo" \
                -p 6379:6379 \
                --restart=always \
...
# Limitar Uso do ivertionchat Usuario e Conexões
USER_LIMIT=99
...
#######################################
# updates ivertionchat
# Arguments:
#   None
#######################################
git_update() {
  print_banner
  printf "${WHITE} 💻 Atualizando o ivertionchat do git...${GRAY_LIGHT}"
  printf "\n\n"
