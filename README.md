...
```
```bash
git clone git@github.com:Mundo-Do-Software/ivertionchat.instalador.git ivertionchatinstalador
```
Editar dados com seus dados, com nano para salvar aperta Ctrl + x
```bash
nano ./ivertionchatinstalador/config
```
```bash
sudo chmod +x ./ivertionchatinstalador/ivertionchat
```
```bash
cd ./ivertionchatinstalador
```
```bash
sudo ./ivertionchat
```
...
-  [Como usar autoinstalador do ivertionchat - Video](https://youtu.be/-Woqu4W5Zzs?si=jcZYX3yPL60XkAd_)
-  [Como usar autoinstalador do ivertionchat - Video opção 2](https://youtu.be/bZ-jXRtcGyc?si=B8oQxv0V0V36fgrF)

## Alterar Frontend

Para mudar nome do aplicativo:

/home/deploy/ivertionchat.io/frontend/quasar.conf

/home/deploy/ivertionchat.io/frontend/src/index.template.html

Para alterar logos e icones:

pasta /home/deploy/ivertionchat.io/frontend/public

Para alterar cores:

/home/deploy/ivertionchat.io/frontend/src/css/app.sass

/home/deploy/ivertionchat.io/frontend/src/css/quasar.variables.sass
